...
import com.frost.vkvideomanager.album.AlbumAdapter;
import com.frost.vkvideomanager.album.EditAlbumDialogFragment;
import com.frost.vkvideomanager.mosby.presenter.AlbumsPresenter;
...
public class AlbumsFragmentMosby extends MvpLceViewStateFragment<SwipeRefreshLayout, List<Album>, AlbumsView, AlbumsPresenter>
    ...
    public static AlbumsFragmentMosby newInstance() {
        return new AlbumsFragmentMosby();
    }
