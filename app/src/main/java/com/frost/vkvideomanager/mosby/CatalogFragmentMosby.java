...
import com.frost.vkvideomanager.mosby.presenter.CatalogPresenter;
...
public class CatalogFragmentMosby extends MvpLceViewStateFragment<SwipeRefreshLayout, List<CatalogSection>, CatalogView, CatalogPresenter>
    ...
    public static CatalogFragmentMosby newInstance() {
        return new CatalogFragmentMosby();
    }
