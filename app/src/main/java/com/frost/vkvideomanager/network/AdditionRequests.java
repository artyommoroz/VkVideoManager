...
import com.frost.vkvideomanager.album.PickAlbumDialogFragment;
        ...
        addVideoRequest.executeWithListener(new VKRequest.VKRequestListener() {
            ...
            public void onComplete(VKResponse response) {
                ...
                if (response.json.optInt("response") == 1) {
                    Toast.makeText(context, context.getString(R.string.video_dialog_add_success_toast,
                            vkApiVideo.title), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
